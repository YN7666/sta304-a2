...
```{r, include=FALSE}
figs_1_2_3 <- read_csv("inputs/data/figs_1_2_3.csv")
age_race_comp_seer <- read_dta("inputs/data/age_race_comp_seer.dta")
nchs_births_pop_1990_2019 <- read_dta("inputs/data/nchs_births_pop_1990_2019.dta")
figs_2a_2b <- read_csv("inputs/data/figs_2a_2b.csv")
```
